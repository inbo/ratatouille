...
This outlines how to propose a change to ratatouille. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("riparias/rato-occurrences", fork = TRUE)`.
...
Please note that the ratatouille project is released with a [Contributor
