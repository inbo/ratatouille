...
#'
#' @param source Character string of the source enum to look up the default resource for.
#'
#' @returns Character string of the default resource path corresponding to the specified
#'  source.
#'
#' @examples
